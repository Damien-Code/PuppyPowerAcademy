                    ...
                    <div v-for="product in props.products" :key="product.id">
                        <a :href="route('webshop.show', product.id)">
                            <div class="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
                                <div class="mb-4 h-56 w-full">
                                    <a v-if="product.mediaFile" :href="product.mediaFile.original_url" target="_blank">
                                        <img :src="product.mediaFile.original_url" class="mx-auto h-full" />
                                    </a>
                                </div>
                                ...
                                <div class="mt-4 flex items-center justify-between gap-4">
                                    <p class="text-2xl leading-tight font-extrabold text-gray-900 dark:text-white">€{{ product.price }}</p>
